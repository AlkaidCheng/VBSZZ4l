...
#define  H4LPARTICLETYPES  23
#define  H4LPARTICLEORIGIN 43
#define  H4LPARTICLEOUTCOME 12
...
namespace H4lMCTruthPartClassifier {
 ...
 struct ParticleDef {
  ...
  ParticleDef()
  {
   ...
   sParticleType.reserve(H4LPARTICLETYPES);
   ...
   sParticleOrigin.reserve(H4LPARTICLEORIGIN);
   ...
   sParticleOutCome.reserve(H4LPARTICLEOUTCOME);
