...
public:
  ...
  //---------------------------------------------------------------------------
  TEvtProb(std::string infile = "input.DAT", std::string workdir = "./");
  ~TEvtProb();
  ...
  void SetHiggsMass(double mass, bool fixedScale=true);

  // 4l interference
  void SetLeptonInterf(TVar::LeptonInterference leptonInterf) {_leptonInterf=leptonInterf; }
//   ClassDef(TEvtProb,0);
};
