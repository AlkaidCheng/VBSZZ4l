...
#define R__DICTIONARY_FILENAME dIafsdIcerndOchdIworkdImdImmittaldIprivatedIMyAnalysisCodedIRootCoreBindIobjdIx86_64mIslc6mIgcc49mIoptdIMCFM_MatrixElementdIobjdIMCFM_MatrixElementCINT
...
namespace {
  void TriggerDictionaryInitialization_MCFM_MatrixElementCINT_Impl() {
    static const char* headers[] = {
0
    };
    static const char* includePaths[] = {
"/afs/cern.ch/work/m/mmittal/private/MyAnalysisCode/MCFM_MatrixElement/Root",
"/afs/cern.ch/work/m/mmittal/private/MyAnalysisCode/MCFM_MatrixElement",
...
"/cvmfs/atlas.cern.ch/repo/ATLASLocalRootBase/x86_64/root/6.04.16-x86_64-slc6-gcc49-opt/include",
"/cvmfs/atlas.cern.ch/repo/ATLASLocalRootBase/x86_64/root/6.04.16-x86_64-slc6-gcc49-opt/include",
"/afs/cern.ch/work/m/mmittal/private/MyAnalysisCode/MCFM_MatrixElement/cmt/",
0
    };
...
extern int __Cling_Autoloading_Map;
  ...
  #define ROOTCORE_PACKAGE "MCFM_MatrixElement"
#endif
...
nullptr};
    ...
    if (!isInitialized) {
      TROOT::RegisterModule("MCFM_MatrixElementCINT",
        headers, includePaths, payloadCode, fwdDeclCode,
        TriggerDictionaryInitialization_MCFM_MatrixElementCINT_Impl, {}, classesHeaders);
      isInitialized = true;
    }
  }
  static struct DictInit {
    DictInit() {
      TriggerDictionaryInitialization_MCFM_MatrixElementCINT_Impl();
    }
  } __TheDictionaryInitializer;
}
void TriggerDictionaryInitialization_MCFM_MatrixElementCINT() {
  TriggerDictionaryInitialization_MCFM_MatrixElementCINT_Impl();
}
